...
public abstract class TestBase {
    ...
    protected ExtentTestReporter reporter;
    ...
    public static List<String> readCSV(String csvFile) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("!!! Error In The CSV File Reading " + csvFile);
        }
        return list;
    }
...
//        String path = System.getProperty("user.dir") + "/src/test/resources/schema/" + JSONFilePath + ".json";
     ...
     * @return return
     */
    public String OracleNULLValueToEmptyFormatter(String value) {
//      String txt = value.replaceAll("null", "");
    ...
    /**
     * @param TWNExcelFileName Read the excel sheet and return 1st column value as List<String>
     * @throws IOException            IOException
     * @throws InvalidFormatException InvalidFormatException
     */
    public static List<String> excelSheetTWNTableNameReader(String TWNExcelFileName) throws IOException, InvalidFormatException {
        String path = System.getProperty("user.dir") + "/src/test/resources/" + TWNExcelFileName;
...
// Write to CSV file which is open
    ...
    public static String getAsciiExtendChars(int n) {
